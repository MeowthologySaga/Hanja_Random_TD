...
const ONE_SHOT_HINTS: readonly OneShotHint[] = [
  ...
  },
  {
    ...
    body: () => "한자를 따라 쓰고 [부적 완성]을 누르면 그 글자의 자령이 보상을 두고 갑니다. 부적은 웨이브마다 1장씩 더해지고 안 쓴 장수는 그대로 쌓이니 서두르지 않아도 됩니다. 획이 많은 글자일수록 보상이 후하고, 이따금 자령이 전장에 손을 씁니다. 그 대신 이 모드에서는 적이 5% 강해져요 — 원치 않으면 설정에서 끌 수 있습니다.",
